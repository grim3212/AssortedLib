...
public class FabricPlatformInventoryStorageHandlerSided implements IPlatformInventoryStorageHandler {
    ...
    private final Map<Direction, SlottedStorage<ItemVariant>> inventoryStorageMap;
    ...
    public SlottedStorage<ItemVariant> getFabricInventory(@Nullable Direction direction) {
